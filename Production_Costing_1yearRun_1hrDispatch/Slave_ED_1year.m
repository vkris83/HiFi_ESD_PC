...
fid=fopen('C:\tomlab\problem_ED.mps', 'w');
...
% cd ('C:\tomlab')
% startup;
[F_ED1,c_ED1,A_ED1,b_L_ED1,b_U_ED1,x_L_ED1,x_U_ED1,IntVars_ED1] = cpx2mat('C:\tomlab\problem_ED.mps',0);
% A=sparse(A);
F_ED1=sparse(F_ED1);
