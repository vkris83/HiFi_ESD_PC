...
%   Read nodes.txt
fid=fopen('nodes_OptimalAlloc.txt');
...
clear nodes;
%   Read arcs.txt
fid=fopen('arcs_OptimalAlloc.txt');
...
fid=fopen('C:\tomlab\problem_UC_OptimalAllocation.mps', 'w');
...
% cd ('C:\tomlab')
% startup;
[F_UC,c_UC,A_UC,b_L_UC,b_U_UC,x_L_UC,x_U_UC,IntVars_UC] = cpx2mat('C:\tomlab\problem_UC_OptimalAllocation.mps',0);
