...
OR1=350; % Gen. max. spinning reserve 
T=C{1,2};
W=C{1,3};
Num_st=0;
Num_rhs=0;
...
t_num=1;
dr=0;
lol=300;        % load not served penalty
...
fid=fopen('C:\tomlab\problem_UChr_peter.mps', 'w');
...
% cd ('C:\tomlab')
% startup;
[F_UC,c_UC,A_UC,b_L_UC,b_U_UC,x_L_UC,x_U_UC,IntVars_UC] = cpx2mat('C:\tomlab\problem_UChr_peter.mps',0);